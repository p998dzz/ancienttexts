...
function loadEntries(option){
    ...
    { url: "text/all/",
      success: function(result){
        ...
        reorganize(option);
        $("#mainDescription").text("Search the library for linear B texts from all over the world. Collection is constantly updated. Currently contains "+result.entries.length+" entries.");
      },
